...
describe('FileUtils', () => {
    describe('validateFile', () => {
        it('should validate file size correctly', () => {
            ...
            expect(() => validateFile(largeBuffer, 'test.pdf')).toThrow(FileProcessingError);
        });
        ...
        it('should validate file type correctly', () => {
            ...
            expect(() => validateFile(buffer, 'test.exe')).toThrow(FileProcessingError);
        });
    });
    ...
    describe('readTemplate', () => {
        ...
        it('should throw FileProcessingError when template read fails', async () => {
            ...
            await expect(readTemplate('test.txt', '/templates'))
                .rejects
    ...
    describe('listFiles', () => {
        ...
        it('should throw FileProcessingError when directory read fails', async () => {
            ...
            await expect(listFiles('/test-dir'))
                .rejects
                .toThrow(FileProcessingError);
        });
    });

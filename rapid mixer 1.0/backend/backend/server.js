...
// Middleware
app.use(cors({
    origin: ['http://localhost:3000', 'https://shankarelavarasan.github.io', 'https://rapid-mixer-backend.onrender.com'],
    credentials: true
}));
...
app.listen(PORT, '0.0.0.0', () => {
    console.log(`🎵 Rapid Mixer Backend Server running on port ${PORT}`);
    console.log(`🚀 Health check: http://localhost:${PORT}/health`);
    console.log(`📁 Upload endpoint: http://localhost:${PORT}/api/audio/upload`);
    console.log(`🎼 Sample tracks: http://localhost:${PORT}/api/audio/samples`);
});

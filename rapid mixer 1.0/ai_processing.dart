...
class _AIProcessingState extends State<AIProcessing>
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            ...
            child: Text('Cancel', style: TextStyle(color: AppTheme.errorColor)),
          ),
        ],
      ),
    );
  ...
  void _navigateToTrackEditor() {
    Navigator.pushReplacementNamed(
      context,
      '/track-editor',
      arguments: {'inputFile': _inputFileData, 'stems': _resultStems},
    );
  }
  ...
  void _showErrorDialog(String error) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(error, style: AppTheme.darkTheme.textTheme.bodyMedium),
        actions: [
          TextButton(
            onPressed: () {
              Navigator.pop(context);
            ...
            child: Text('Retry', style: TextStyle(color: AppTheme.accentColor)),
          ),
          TextButton(
            onPressed: () {
              Navigator.pop(context);
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  _isCompleted ? "Processing Complete!" : "AI Stem Separation",
